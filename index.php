...
<title>PIM / Pay, Invest, Manage</title>
<!-- Bootstrap core CSS -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"> 
          ...
          <!-- LOGO IMAGE --> 
          <a href="?home"> <img class="img-responsive logo" src="images/logo.jpg" alt="logo"> </a> 
          <!-- /LOGO IMAGE --> 
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
    ...
    <div class="pattern-overlay">
      <div class="header-container">
        <div class="video-container">
          <video   poster="images/bg.jpg" preload="metadata" id="my-video" class="video-play" muted="muted" loop autoplay>
            <source src="media/hd.mp4"  type="video/mp4">
          ...
          <div  id="video_xs">
              ...
              <video id="video" poster="images/bg-video.png" preload="metadata"  height="340" width="360">
                <source src="media/hd.mp4" type="video/mp4">
                <source src="media/video.ogv" type="video/ogg">
                <source src="media/video.webm" type="video/webm">
              </video>
            ...
            <div class="modal-dialog"> 
              ...
              <div class="modal-content">
                <div class="modal-body">
                  ...
                  <video autobuffer preload="metadata" id="video-pop" class="video-play video-pop"  loop>
                    <source src="media/hd.mp4" type="video/mp4">
                    <source src="media/video.ogv" type="video/ogg">
                    <source src="media/video.webm" type="video/webm">
                  </video>
          ...
          <div class="row">
            <div class="col-lg-12">
              <h1>Improve your shopping<br>
                experience</h1>
              <h3><a href="" class="link-modal link-dsk btn-play" data-toggle="modal" data-target="#myvideop">LEARN HOW</a></h3>
              <h3><a class="link-modal link-mobile okplay" >LEARN HOW</a></h3>
            </div>
          </div>
        </div>
      </div>
...
var myVar;
    ...
    function myFunction() {
      <?php 
        if(isset($_GET["resultat"]) || isset($_GET["home"])){
           echo "showPage();";
        }else{
           echo "myVar = setTimeout(showPage, 1500);";
